...
export function Login() {
  ...
  const handleNaverLogin = () => {
    window.location.href = "https://selfmade-umqd.onrender.com/oauth2/authorization/naver";
  };

  const handleKakaoLogin = async () => {
    try {
      // ✅ 1. 카카오 로그인 페이지로 리디렉트 요청
      window.location.href = "https://selfmade-umqd.onrender.com/oauth2/authorization/kakao";
    } catch (error) {
